...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book Lenguage (e.g. English, Spanish, etc.)', max_length=200, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Book',
        ...
        migrations.AddConstraint(
            model_name='lenguage',
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower('name'), name='lenguage_name_case_insensitive_unique', violation_error_message='Lenguage already exists (case insensitive match)'),
        ),
        migrations.AddField(
            model_name='book',
            name='lenguage',
